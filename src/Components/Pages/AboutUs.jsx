...
const AboutUs = () => {
  ...
  return (
    <div>
      ...
      <div className="AboutUS display flex">
        <div className="img w-400">
          <img src={Aboutus} alt="" />
        </div>
      ...
      <div className="TeamMateInfo flex gap-5 pb-18">
        <div className="card bg-base-100 w-96 shadow-sm">
          <figure>
            <img src="https://img.daisyui.com/images/stock/photo-1606107557195-0e29a4b5b4aa.webp" alt="Shoes" />
          </figure>
          <div className="card-body">
            <h2 className="card-title"> Card Title <div className="badge badge-secondary">NEW</div>
      ...
      <div className="HiringForJob flex">
        <div className="info w-[70%] mt-20 ml-15">
          <h2 className='text-4xl font-semibold italic'> Job Seekers :</h2>
          ...
          <h2 className='text-4xl font-semibold italic mt-10'> Employers & Companies :</h2>
        ...
        <div className="img w-[30%]  "><img className='' src={Hiring} alt="" /></div>
      </div>
      ...
      <div className="EarnRevenue flex gap-3 pb-20">
        <div className="card bg-base-100 w-96 shadow-sm rounded-xl">
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="mt-6">
              <button className="btn text-orange-950 btn-block">Read More</button>
            </div>
          </div>
        </div>
        <div className="card bg-base-100 w-96 shadow-sm rounded-xl">
      ...
      <div className="ProVertion flex justify-center gap-5 pb-20">
        {/* free */}
        <div className="card w-96 bg-base-100 shadow-sm group ">
