...
const FindUs = () => {
    return (
        <div className='items-center text-center'>
           ...
           <div>
             <div className="join join-vertical w-full text-center ">
                <button className="btn bg-base-100 justify-start join-item text-center"><FaFacebook></FaFacebook> Facebook</button>
